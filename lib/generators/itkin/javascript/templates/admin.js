$(function(){
  ...
  $('.pagination a, a.new').live('click', function(e){
      e.preventDefault();
      var $wrapper = $(this).closest(".ui-tabs-panel").find(".list-wrapper");
      $wrapper.fadeTo(500,0);
      $wrapper.load($(this).attr('href')+' .list-wrapper',function(){
  ...
  $('input.search').livequery(function(){
    $(this).searchBox({
      ...
      container: $(this).closest(".ui-tabs-panel").find('.list-wrapper'),
      target: '.list-wrapper'
    })
  });
